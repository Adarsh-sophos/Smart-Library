...
def generate_unique_id_incremental():
    ...
    submissions_path = main.BASE_PATH + '/data/submissions'
...
def create_new_submission(file):
    ...
    directory = main.BASE_PATH + '/data/submissions/' + id
    ...
    os.makedirs(directory + '/extracted_spines')
    os.makedirs(directory + '/bounding_boxes')
    os.makedirs(directory + '/texts_detected')
...
def get_raw_image_path_from_submission_id(submission_id):
    ...
    file_directory = main.BASE_PATH + '/data/submissions/' + submission_id + '/raw_img'
...
def get_pickle_directory_from_submission_id(submission_id):
    ...
    # Get the directory of the raw_file file for the submission_id
    pickle_directory = main.BASE_PATH + '/data/submissions/' + submission_id + '/books'
...
def get_info_directory_from_submission_id(submission_id):
    ...
    info_directory = main.BASE_PATH + '/data/submissions/' + submission_id + '/info'

    return info_directory


def get_extracted_spines_directory_from_submission_id(submission_id):
    '''
    Returns the correct path to the info directory for submission_id
    '''

    extracted_spines_directory = main.BASE_PATH + '/data/submissions/' + submission_id + '/extracted_spines'

    return extracted_spines_directory


def get_bounding_boxes_directory_from_submission_id(submission_id):
    '''
    Returns the correct path to the info directory for submission_id
    '''

    bounding_boxes_directory = main.BASE_PATH + '/data/submissions/' + submission_id + '/bounding_boxes'

    return bounding_boxes_directory


def get_texts_detected_directory_from_submission_id(submission_id):
    '''
    Returns the correct path to the info directory for submission_id
    '''

    texts_detected_directory = main.BASE_PATH + '/data/submissions/' + submission_id + '/texts_detected'

    return texts_detected_directory
